  ...
  return (
    ...
    >
      {error ? (
        ...
        <>
          {/* Camera viewfinder */}
          <div className="relative rounded-2xl overflow-hidden camera-frame mb-5"
            style={{ width: "min(90vw, 380px)", aspectRatio: "3/4" }}
          >
            <video
              ref={videoRef}
              autoPlay
                ...
                >
                  <div className="bg-white/20 backdrop-blur-sm rounded-full w-20 h-20 flex items-center justify-center">
                    <span
                      ...
                      style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontWeight: 400, textShadow: "0 2px 10px rgba(0,0,0,0.25)" }}
                    >
                      {countdown}
                    </span>
                  </div>
